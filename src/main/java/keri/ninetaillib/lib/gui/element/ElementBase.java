...
public abstract class ElementBase {
    ...
    public ElementBase(GuiContainerBase gui, int posX, int posY) {
        this.gui = gui;
        this.posX = posX;
        this.posY = posY;
    }

    public ElementBase(GuiContainerBase gui, int posX, int posY, int width, int height) {
        this.gui = gui;
        this.posX = posX;
        this.posY = posY;
        this.sizeX = width;
    ...
    public final GuiContainerBase getContainerScreen() {
        return gui;
    }
