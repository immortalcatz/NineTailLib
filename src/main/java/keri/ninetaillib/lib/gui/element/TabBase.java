...
public class TabBase extends ElementBase {
    ...
    protected ArrayList<ElementBase> elements = Lists.newArrayList();
    public static final ResourceLocation DEFAULT_TEXTURE_LEFT = new ResourceLocation(ModPrefs.MODID  + "textures/gui/tab_left.png");
    public static final ResourceLocation DEFAULT_TEXTURE_RIGHT = new ResourceLocation(ModPrefs.MODID  + "textures/gui/tab_right.png");

    public TabBase(GuiContainerBase gui) {
        super(gui, 0, 0);
        texture = DEFAULT_TEXTURE_RIGHT;
    }

    public TabBase(GuiContainerBase gui, int side) {
        super(gui, 0, 0);
        this.side = side;
