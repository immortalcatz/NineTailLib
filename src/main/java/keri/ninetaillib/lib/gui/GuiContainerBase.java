...
public class GuiContainerBase extends GuiContainer {
    ...
    public ArrayList<TabBase> tabs = Lists.newArrayList();
    protected ArrayList<ElementBase> elements = Lists.newArrayList();
    protected List<String> tooltip = Lists.newLinkedList();
    ...
    protected void mouseClickMove(int mX, int mY, int lastClick, long timeSinceClick) {
        ...
        if (this.dragSplitting && slot != null && !itemstack.isEmpty() && slot instanceof SlotDummy) {
    ...
    public void drawFluid(int x, int y, FluidStack fluid, int width, int height) {
        ...
        new ColourRGBA(color).glColour();
        drawTiledTexture(x, y, TextureUtils.getTexture(fluid.getFluid().getStill(fluid)), width, height);
    }
